...
Reference for the site's visual identity, based on the design system of the desktop app.
...
Dark mode inverts the same scale (background `oklch(0.145 0 0)`, foreground `oklch(0.985 0 0)`, etc.) — see `src/index.css` in the app repo for the full token set if exact parity is needed.
